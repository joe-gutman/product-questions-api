...
var postAnswer = (request) => {
  return new Promise((resolve, reject) => {
    ...
    db.query('INSERT INTO answers (question_id, body, answerer_name, answerer_email, photos) VALUES ($1, $2, $3, $4, $5, $6)', [question_id, body, answerer_name, answerer_email])
      .then((results) => {
        answers = results.rows;
        var photoPromises = [];
      ...
      .then((results) => {
        answers.forEach((answer, index) => {
          answer.photos = results[index].rows;
        })
        resolve(answers);
      })
      .catch((error) => {
